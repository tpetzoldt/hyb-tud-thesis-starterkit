...
The templates are based on the corporate design of TU Dresden (in Word format) and the official LaTeX package tudcd-scr  (https://github.com/tud-cd/tudcd-scr/), in order to maintain a consistent style.
