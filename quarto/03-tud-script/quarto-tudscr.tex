...
Hilfe des Latex-Systems (Lamport, 2005) ein PDF erzeigt werden kann. Als
...
ist, höchstwahrscheinlich auf Grund eingeschränkter oder fehlender
...
\captionsetup{labelsep=none}\includegraphics{pdf-plot.pdf}

}

\caption{\label{fig-external-figure}}
...
\caption{\label{fig-histogram}Histogramm von 100 Zufallszahlen}
...
Lamport, L. (2005). \emph{The LaTeX Manual} (2nd Aufl.). {American
...
1.4.554) {[}Computer software{]}. \url{https://quarto.org}
